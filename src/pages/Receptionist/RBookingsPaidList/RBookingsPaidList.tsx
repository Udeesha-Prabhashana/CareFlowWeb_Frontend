...
const RBookingsPaidList: React.FC = () => {
    ...
    const handleViewDetails = (row: { number: number, name: string }) => {
        ...
        navigate("/receptionist/bookings/paidsummary");
    };
            ...
            <div className="navRec">
                ...
                <div className="mainContentRecBooking">
                    ...
                    <div className="subContentRecBooking">
                        View Details of Patients Bookings
                    </div>
...
export default RBookingsPaidList;