...
import "./RBookingsPaidSummmary.scss";
...
const RBookingsPaidSummmary: React.FC = () => {
    ...
    return (
        <div className="RBookingsPaidSummmary">
            <NavbarLu />
            <div className="BookingsPaidSummmarysContainer">
                <SidebarRec />
...
export default RBookingsPaidSummmary;