...
import "../../Receptionist/RNotifications/RNotifications.scss";
...
const RNotifications: React.FC = () => {
    ...
    return (
        <div className="notificationsRec">
            <SidebarRec />
            <div className="notificationsContainerRec">
                {/* <NavbarAd /> */}
                <div className="mainContentRec" style={{ position: 'absolute', top: 0 }}>
                    Notifications
                    <div className="subContentRec">View upcoming updates</div>
                    ...
                    <div className="cardsContainerRec">{getNotificationCards()}</div>
                </div>
            </div>
        </div>
    );
