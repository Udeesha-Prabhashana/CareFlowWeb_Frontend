...
const DoctorNLU: React.FC = () => {
  ...
  return (
    <div>
      <Navbar />
      <Header type="list" />
    <div className="homenlu">
      <>
        <div className="hotelContainernLU">
          {open && (
            <div className="slidernLU">
              <FontAwesomeIcon icon={faCircleXmark} className="closenLU" onClick={() => setOpen(false)} />
              <FontAwesomeIcon icon={faCircleArrowLeft} className="arrownLU" onClick={() => handleMove("l")} />
              <div className="sliderWrappernLU">
                <img src={data.photos[slideNumber]} alt="" className="sliderImgnLU" />
              </div>
          ...
          <div className="hotelWrappernLU">
            ...
            <span className="hotelDistancenLU">Excellent location {data.distance}m from center</span>
            {/* <span className="hotelPriceHighlight">Book a stay over ${data.cheapestPrice} at this property and get a free airport taxi</span> */}
            <div className="hotelImagesnLU">
              {data.photos.map((photo, i) => (
                <div className="hotelImgWrappernLU" key={i}>
                  <img onClick={() => handleOpen(i)} src={photo} alt="" className="hotelImg" />
                </div>
              ))}
            </div>
            <div className="hotelDetailsnLU">
              <div className="hotelDetailsTextsnLU">
                <h1 className="hotelTitlenLU">{data.title}</h1>
                <p className="hotelDescnLU">{data.desc}</p>
              </div>
              <div className="hotelDetailsPricenLU">
