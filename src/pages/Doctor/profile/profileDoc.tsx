...
import "../profile/profileDoc.scss";
import "../../../tailwind.css";
        ...
        <div className="sideDoc">
            ...
            <div className="navDoc">
                ...
                <div className="mainContentDocBooking">
                    <h1>Bookings</h1>
                    <p className="subContentDocBooking">
                    ...
                    <div className="flex flex-col w-full ml-14 mr-14">
                        <div className="flex mb-4">
                            <div className="flex flex-col flex-grow mr-4">
                                <label htmlFor="fname" className="text-gray-700 mb-2">First Name</label>
                            ...
                            <div className="flex flex-col flex-grow">
                                <label htmlFor="lname" className="text-gray-700 mb-2">Last Name</label>
                                <div className="flex items-center border border-purple-500/90 rounded-lg">
                                    <input
                                        id="lname"
                                        type="text"
                        ...
                        <div className="flex mb-4">
                            <div className="flex flex-col flex-grow mr-4">
                                <label htmlFor="dob" className="text-gray-700 mb-2">Date of Birth</label>
                                <div className="flex items-center border border-purple-500/90 rounded-lg">
                                    <input
                                        id="dob"
                                        type="text"
                            ...
                            <div className="flex flex-col flex-grow">
                                <label htmlFor="pno" className="text-gray-700 mb-2">Phone Number</label>
                                <div className="flex items-center border border-purple-500/90 rounded-lg">
                                    <input
                                        id="pno"
                                        type="text"
                        ...
                        <div className="flex mb-4">
                            <div className="flex flex-col flex-grow mr-4">
                                <label htmlFor="height" className="text-gray-700 mb-2">Height</label>
                                <div className="flex items-center border border-purple-500/90 rounded-lg">
                                    <input
                                        id="height"
                                        type="text"
                        ...
                        <div className="flex mb-4">
                            <div className="flex flex-col flex-grow">
                                <label htmlFor="medicines" className="text-gray-700 mb-2">Medicines</label>
                                <div className="flex items-center border border-purple-500/90 rounded-lg">
                                    <textarea
                                        id="medicines"
